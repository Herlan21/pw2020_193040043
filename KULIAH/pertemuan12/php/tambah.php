...
<body>
  ...
  <form class="tambah" action="" method="POST">
    ...
    <div class="form-group">
      ...
      <input name="foto" type="text" class="form-control" aria-describedby="emailHelp" placeholder="Masukkan Nama Cover Buku">
      <small id="emailHelp" class="form-text text-muted">Silahkan Masukkan foto mahasiswa</small>
    </div>
    ...
    <div class="form-group">
      ...
      <input name="nrp" type="text" class="form-control" placeholder="Masukkan NRP Mahasiswa">
    </div>
