...
<body>
  ...
  <form action="" method="POST">
    ...
    <div class="form-group">
      <label for="cover" name="cover">Cover</label>
      <input type="text" class="form-control" aria-describedby="emailHelp" placeholder="Masukkan Nama Cover Buku">
    ...
    <div class="form-group">
      <label for="pengarang" name="pengarang">Pengarang</label>
      <input type="text" class="form-control" placeholder="Masukkan Nama Pengarang">
    </div>


    <div class="form-group">
      <label for="tahun_terbit" name="tahun_terbit">Tahun Terbit</label>
