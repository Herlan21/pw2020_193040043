...
<body>
  ...
  <a href="tambah.php" class="btn btn-primary btn-lg active" role="button" aria-pressed="true">Tambah Data</a>
          ...
          <div class="col-sm-3 mb-3">
            <div class="card  mt-3">
              ...
              <div class="card-body">
                ...
                <a href="detail.php?id=<?= $bk['id_buku']; ?>" class="btn btn-primary">Edit</a>
                <a href="detail.php?id=<?= $bk['id_buku']; ?>" class="btn btn-primary">Hapus</a>
              </div>
            </div>
          </div>
